...
public class Depress {
    ...
    public static void main(String[] args) {
        ...
        String[] zipfiles = {
            ...
            "src/files/A Study In Scarlet 1.txt",
    
            "src/files/四签名 1.txt",

            "src/files/最后一案 1.txt",

            "src/images/奥拉夫 1.png",

            "src/images/bizzarStore 1.png",
    
            "src/videos/Steam 1.mp4",

            "src/videos/sxbank 1.mp4",

            "src/music/看月亮 1.mp3",
    
            "src/music/Fish in the pool 1.mp3"
